...
''' 
This is a word jumble game in which you will be given a string of alphabets and you have to reorder the alphabets in the string to make a name of a country.
'''
